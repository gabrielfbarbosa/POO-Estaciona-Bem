...
public class Estacionamento {
    ...
    public static void main(String[] args) {
       ...
       Veiculo v1 = new Veiculo("Placa X",  c1, "Carro");
       c1.getVeiculos().add(v1);
       Veiculo v2 = new Veiculo("Placa Y",  c1, "Moto");
       c1.getVeiculos().add(v2);
       Veiculo v3 = new Veiculo("Placa Z",  c1, "Carro");
       c1.getVeiculos().add(v3);
       clientes.add(c1);
       
       
       Vaga vaga1 = new Vaga(123, "Rua Tal", "Moto");
       vagas.add(vaga1);
       Vaga vaga2 = new Vaga(124, "Rua Tal", "Carro");
       vagas.add(vaga2);
...
/*===============================================3 - Gerenciar estacionamento===============================================*/                    
                    if(clientes.size() > 0 && vagas.size() > 0){
                        ...
                        if(opSecundaria == 1){
                            funcao.getOpEstacionar().estacionar(vagas, clientes, tickets, dias);
                        } else if(opSecundaria == 2){
                            funcao.getOpEstacionar().retirar(vagas,clientes, tickets, ticketsFinalizados, dias);
                        } else if(opSecundaria == 3){
                            JOptionPane.showMessageDialog(null, funcao.getOpEstacionar().listaVagas(vagas), "Estaciona Bem", JOptionPane.INFORMATION_MESSAGE);
                        } else if(opSecundaria == 4){
                            funcao.getOpEstacionar().gerenciarTarifa(dias);
                        } else if(opSecundaria == 5){
